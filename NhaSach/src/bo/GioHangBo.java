...
public class GioHangBo {
	 ...
	 */
	public void ThemSach(String maSach, String tenSach, String anh, String tacGia, double gia, int soLuong) {
		...
		ds.add(new GioHangBean(maSach, tenSach, anh, tacGia, gia, soLuong));
	}
	
	public void suaGioHang(String maSach, String tenSach, String anh, String tacGia, double gia, int soLuong) {
		/*
